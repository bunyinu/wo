...
# Removed Daytona import
# from daytona_sdk.process import SessionExecuteRequest

from agentpress.tool import ToolResult, openapi_schema, xml_schema
from sandbox.sandbox import SandboxToolsBase, get_or_start_sandbox
...
class SandboxFilesTool(SandboxToolsBase):
    """Tool for executing file system operations in a sandbox. All operations are performed relative to the /workspace directory."""
