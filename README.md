...
# Moyo - Open Source Generalist AI Agent

(that acts on your behalf)

![Moyo Screenshot](frontend/public/banner.png)

Moyo is a fully open source AI assistant that helps you accomplish real-world tasks with ease. Through natural conversation, Moyo becomes your digital companion for research, data analysis, and everyday challenges—combining powerful capabilities with an intuitive interface that understands what you need and delivers results.

Moyo's powerful toolkit includes seamless browser automation to navigate the web and extract data, file management for document creation and editing, web crawling and extended search capabilities, command-line execution for system tasks, website deployment, and integration with various APIs and services. These capabilities work together harmoniously, allowing Moyo to solve your complex problems and automate workflows through simple conversations!
...
- [Moyo Architecture](#project-architecture)
...
Moyo consists of four main components:

### Backend API
Python/FastAPI service that handles REST endpoints, thread management, and LLM integration with xAI Grok and Mercury via LiteLLM.
...
Moyo can be self-hosted on your own infrastructure. Follow these steps to set up your own instance.
...
- API keys for LLM providers (xAI Grok and Mercury)
...
3. **LLM API Keys**:
   - Obtain an API key from [xAI Grok](https://grok.x.ai/) and [Mercury](https://platform.inceptionlabs.ai/)
...
```bash
git clone https://github.com/kortix-ai/moyo.git
cd moyo
```
...
7. **Access Moyo**:
   ...
   - Start using your self-hosted Moyo instance!
...
- [xAI Grok](https://grok.x.ai/) - LLM provider
- [Mercury](https://platform.inceptionlabs.ai/) - LLM provider
...
Kortix Moyo is licensed under the Apache License, Version 2.0. See [LICENSE](./LICENSE) for the full license text.
